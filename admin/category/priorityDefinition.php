...
if($_POST['submitPri'])
{
	...
	echo "<tr><td bgcolor='#99CCFF'>Pri (C/B/A)</td><td bgcolor='#99CCFF'>Risk</td><td bgcolor='#99CCFF'>Imp</td></tr>\n\n";
	...
	while($row = mysql_fetch_array($result)){
		...
		if($priority == 'a')
		{
			...
			$priRadio = "<input type='radio' name='priority" . $id . "' value='c'><input type='radio' name='priority" . $id . "' value='b'><input type='radio' name='priority" . $id . "' value='a' CHECKED>";

		}elseif($priority == 'b')
		{


			$priRadio = "<input type='radio' name='priority" . $id . "' value='c'><input type='radio' name='priority" . $id . "' value='b' CHECKED><input type='radio' name='priority" . $id . "' value='a'>";

		}elseif($priority == 'c')
		{


			$priRadio = "<input type='radio' name='priority" . $id . "' value='c' CHECKED><input type='radio' name='priority" . $id . "' value='b'><input type='radio' name='priority" . $id . "' value='a'>";

		}

		echo $priRadio . "</td>";
		echo "<td>" . substr($riskImp, 0,1) . "</td><td>" . substr($riskImp, 1,2) . "<td></td></tr>";
