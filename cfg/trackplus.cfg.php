...
/* anonymous login into trackplus has to be turned on, and a trackplus user has to created with viewer rights to all public projects
/* Change the following in your trackplus config_inc.php (replace dummy with your created user)
 	# --- anonymous login -----------
