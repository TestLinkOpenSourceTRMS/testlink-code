 ...
 */
$tlCfg->charts_font_path = TL_ABS_PATH .
    "vendor/wp-statistics/pchart/src/Fonts/tahoma.ttf";
/**
...
$tlCfg->testcase_cfg->relations->type_labels = array(
    ...
    TL_REL_TYPE_AUTOMATION_PARENT_CHILD => [
        'source' => 'automates_also',
        'destination' => 'is_automated_by'
    ],
    TL_REL_TYPE_EXECUTE_TOGETHER => [
 ...
 * Plugins feature
 */
define('TL_PLUGIN_PATH',
    dirname(__FILE__) . DIRECTORY_SEPARATOR . 'plugins' . DIRECTORY_SEPARATOR);
...
if (! isset($tlCfg->attachments->access_icon)) {
    $tlCfg->attachments->access_icon = '<img src="' . $tlCfg->theme_dir .
...
define('TL_XMLEXPORT_HEADER',
    "<?xml version=\"1.0\" encoding=\"" . $tlCfg->charset . "\"?>\n");
