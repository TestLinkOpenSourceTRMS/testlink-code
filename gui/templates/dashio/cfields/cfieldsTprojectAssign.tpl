      ...
      <table class="{#item_view_table#}" id="item_view"
        ...
        <thead class="{#item_view_thead#}">
          <tr>
      		...
      		<th 
          data-orderable="false" width="15%">{$labels.display_order}</th>
      		<th data-orderable="false" width="5%">{$labels.location}</th>
      		<th data-orderable="false" 
              width="5%">{$labels.cfields_active}</th>
          <th data-orderable="false" width="5%">{$labels.required}</th>
          <th data-orderable="false" width="5%">{$labels.monitorable}</th>
      	</tr>
        </thead>
