  ...
  <form id="req_operations" name="req_operations">
    <fieldset class="groupBtn">
      ...
      {if $gui->grants->req_mgmt == "yes"}
        ...
        <input class="{#BUTTON_CLASS#}" type="button"
               name="createReqFromIssueXML" 
               id="createReqFromIssueXML"
               value="{$labels.btn_create_from_issue_xml}"
               onclick="location='{$req_create_from_issue_xml_url}'" />

        {if $gui->requirements_count > 0}
          <input class="{#BUTTON_CLASS#}" type="button"
                 name="create_tcases" id="create_tcases"
                 value="{$labels.req_select_create_tc}" onclick="location='{$req_create_tc_url}'" />
        
          <input class="{#BUTTON_CLASS#}" type="button" 
                 name="copy_req" id="copy_req" 
                 value="{$labels.btn_copy_requirements}"
                 onclick="location='{$req_spec_copy_req_url}'" />

          <input class="{#BUTTON_CLASS#}" type="button" 
                 name="bulk_mon" id="bulk_mon"
                 value="{$labels.btn_bulk_mon}"
