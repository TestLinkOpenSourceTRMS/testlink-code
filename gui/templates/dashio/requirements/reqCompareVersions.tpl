...
{if $gui->compare_selected_versions}
	...
	<h1 class="{#TITLE_CLASS#}">{$labels.title_compare_versions_req}</h1> 
...
{else}
	...
	<p>
		<input class="{#BUTTON_CLASS#}" type="submit" 
           name="compare_selected_versions" 
           id="compare_selected_versions"
           value="{$labels.btn_compare_selected_versions}" />
		<input class="{#BUTTON_CLASS#}" type="button" 
           name="cancel" id="cancel_top"
	...
	<p>
		...
		<input class="{#BUTTON_CLASS#}" 
           type="submit" 
           name="compare_selected_versions" 
           id="compare_selected_versions_bottom"
           value="{$labels.btn_compare_selected_versions}" />
		<input class="{#BUTTON_CLASS#}" type="button" 
           name="cancel" id="cancel_bottom"
           value="{$labels.btn_cancel}" onclick="javascript:history.back();" />
	</p>
