...
{lang_get var="labels"
          s='warning_empty_testsuite_name,title_edit_level,
             btn_save,tc_keywords,cancel,warning,
             warning_unsaved'}
...
<h1 class="{#TITLE_CLASS#}">{lang_get s=$level}{$smarty.const.TITLE_SEP}{$name|escape}</h1> 
...
<div class="workBack">
  ...
  <div>
    ...
    <input class="{#BUTTON_CLASS#}" type="submit" 
           name="update_testsuite" id="update_testsuite" 
  ...
  <div>
    <input class="{#BUTTON_CLASS#}" type="submit" 
           name="update_testsuite" id="update_testsuite_bottom" 
           value="{$labels.btn_save}" 
           onclick="show_modified_warning = false; doAction.value='update_testsuite'" />
    <input class="{#BUTTON_CLASS#}" type="button" 
           name="go_back" id="go_back_bottom" 
           value="{$labels.cancel}" 
           onclick="javascript: show_modified_warning = false; history.back();"/>
  </div>
  </form>
