...
{lang_get var="lbl"
  s="requirement_spec,Requirements,tcversion_is_inactive_msg,
    btn_edit,btn_delete,btn_mv_cp,btn_del_this_version,
    btn_new_version,
    ...
    btn_add_to_testplans,applyExecTypeChangeToAllSteps,
    ...
    hint_new_version,
    execution_type,test_importance,importance,none,preconditions,
    btn_compare_versions,btn_bulk,
    show_ghost_string,display_author_updater,onchange_save,
    estimated_execution_duration,status,btn_save,
    ...
    testcase_operations,
    testcase_version_operations,goto_execute,aliens,external_ref"}
