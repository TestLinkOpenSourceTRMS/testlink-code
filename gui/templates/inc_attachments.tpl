...
$Id: inc_attachments.tpl,v 1.9 2007/01/23 18:26:41 franciscom Exp $
...
<table class="{$tableClassName}" style="{$tableStyles}">
	...
	{/if}
  	...
  	<tr>
		...
		{if !$downloadOnly}
		<a href="javascript:deleteAttachment_onClick({$info.id});"><img style="border:none" alt="{lang_get s='alt_delete_build'}" src="{$smarty.const.TL_THEME_IMG_DIR}/thrash.png"/></a>
		{/if}
		</td>
	</tr>
	{/foreach}
