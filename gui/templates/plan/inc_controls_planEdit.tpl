...
$Id: inc_controls_planEdit.tpl,v 1.2 2009/08/08 14:08:20 franciscom Exp $
...
{lang_get var="labels"
          s='testplan_copy_builds,testplan_copy_tcases,testplan_copy_tcases_latest,
		         ...
		         testplan_copy_user_roles,testplan_copy_platforms_links'}

<table style="float: left; text-align:left">
	<tr><td align='right'>{$labels.testplan_copy_tcases}</td>
		<td align='left'>
		<input type="checkbox" name="copy_tcases" checked="checked"/>
		{$labels.testplan_copy_tcases_latest}<input type="radio" value="latest" name="tcversion_type"/>
