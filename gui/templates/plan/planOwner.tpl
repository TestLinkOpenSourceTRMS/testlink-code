...
{* $Id: planOwner.tpl,v 1.1 2007/12/02 17:03:00 franciscom Exp $ *}
      ...
      <th>{lang_get s='th_risk'}</th>
		...
		<tr>
			...
			<td><select name="owner">
					...
					{* Changed the smarty syntax for options to show the full user name & id but still submit the login id *}
