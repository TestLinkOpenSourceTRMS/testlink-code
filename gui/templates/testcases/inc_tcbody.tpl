...
<table class="simple">
 ...
 {/if}
	...
	<tr>
		<td colspan="{$inc_tcbody_tableColspan}">{if $gui->designEditorType == 'none'}{$inc_tcbody_testcase.summary|nl2br}{else}{$inc_tcbody_testcase.summary}{/if}<p></td>
	</tr>
	...
	<tr>
		<td colspan="{$inc_tcbody_tableColspan}">{if $gui->designEditorType == 'none'}{$inc_tcbody_testcase.preconditions|nl2br}{else}{$inc_tcbody_testcase.preconditions}{/if}<p></td>
	</tr>
