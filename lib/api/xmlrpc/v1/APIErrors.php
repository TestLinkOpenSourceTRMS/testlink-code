...
define('NO_TCASEVERSIONID', 111);
define('NO_TCASEVERSIONID_STR', lang_get('API_NO_TCASEVERSIONID', null, 1));
...
define('MISSING_REQUIRED_PARAMETER_STR',
    lang_get('API_MISSING_REQUIRED_PARAMETER', null, 1));
...
define('NODEID_IS_NOT_INTEGER_STR', lang_get('API_NODEID_IS_NOT_INTEGER', null,
    1));
...
define('CFG_DELETE_EXEC_DISABLED_STR',
    lang_get('API_CFG_DELETE_EXEC_DISABLED', null, 1));

define('NO_PLATFORMID', 233);
define('NO_PLATFORMID_STR', lang_get('API_NO_PLATFORMID', null, 1));

define('NODEID_INVALID_DATA_TYPE', 234);
define('NODEID_INVALID_DATA_TYPE_STR',
    lang_get('API_NODEID_INVALID_DATA_TYPE', null, 1));

define('PLATFORM_NAME_DOESNOT_EXIST', 235);
define('PLATFORM_NAME_DOESNOT_EXIST_STR',
    lang_get('API_PLATFORM_NAME_DOESNOT_EXIST', null, 1));
...
define('TCASEID_NOT_IN_TPLANID_STR',
    lang_get('API_TCASEID_NOT_IN_TPLANID', null, 1));
...
define('TESTPLANNAME_DOESNOT_EXIST_STR',
    lang_get('API_TESTPLANNAME_DOESNOT_EXIST', null, 1));

define('TESTPLANNAME_ALREADY_EXISTS', 3034);
define('TESTPLANNAME_ALREADY_EXISTS_STR',
    lang_get('API_TESTPLANNAME_ALREADY_EXISTS', null, 1));

define('PLATFORM_NOT_LINKED_TO_TESTPLAN', 3040);
define('PLATFORM_NOT_LINKED_TO_TESTPLAN_STR',
    lang_get('API_PLATFORM_NOT_LINKED_TO_TESTPLAN', null, 1));

define('TESTPLAN_HAS_NO_PLATFORMS', 3041);
define('TESTPLAN_HAS_NO_PLATFORMS_STR',
    lang_get('API_TESTPLAN_HAS_NO_PLATFORMS', null, 1));

define('TCASEID_NOT_IN_TPLANID_FOR_PLATFORM', 3042);
define('TCASEID_NOT_IN_TPLANID_FOR_PLATFORM_STR',
    lang_get('API_TCASEID_NOT_IN_TPLANID_FOR_PLATFORM', null, 1));

define('MISSING_PLATFORMID_BUT_NEEDED', 3043);
define('MISSING_PLATFORMID_BUT_NEEDED_STR',
    lang_get('API_MISSING_PLATFORMID_BUT_NEEDED', null, 1));

define('PLATFORM_ID_NOT_LINKED_TO_TESTPLAN', 3044);
define('PLATFORM_ID_NOT_LINKED_TO_TESTPLAN_STR',
    lang_get('API_PLATFORM_ID_NOT_LINKED_TO_TESTPLAN', null, 1));

define('LINKED_FEATURE_ALREADY_EXISTS', 3045);
define('LINKED_FEATURE_ALREADY_EXISTS_STR',
    lang_get('API_LINKED_FEATURE_ALREADY_EXISTS', null, 1));

define('OTHER_VERSION_IS_ALREADY_LINKED', 3046);
define('OTHER_VERSION_IS_ALREADY_LINKED_STR',
    lang_get('API_OTHER_VERSION_IS_ALREADY_LINKED', null, 1));

define('TCVERSIONID_NOT_IN_TPLANID', 3047);
define('TCVERSIONID_NOT_IN_TPLANID_STR',
    lang_get('API_TCVERSIONID_NOT_IN_TPLANID', null, 1));
...
define('BUILDNAME_ALREADY_EXISTS_STR',
    lang_get('API_BUILDNAME_ALREADY_EXISTS', null, 1));

define('BUILDNAME_DOES_NOT_EXIST', 4040);
define('BUILDNAME_DOES_NOT_EXIST_STR',
    lang_get('API_BUILDNAME_DOES_NOT_EXIST', null, 1));
...
define('INVALID_TCASEVERSIONID', 5001);
define('INVALID_TCASEVERSIONID_STR',
    lang_get('API_INVALID_TCASEVERSIONID', null, 1));
define('TCASEID_NOT_INTEGER', 5010);
define('TCASEID_NOT_INTEGER_STR', lang_get('API_TCASEID_NOT_INTEGER', null, 1));
define('TCASEVERSIONID_NOT_INTEGER', 5011);
define('TCASEVERSIONID_NOT_INTEGER_STR',
    lang_get('API_TCASEVERSIONID_NOT_INTEGER', null, 1));
define('TESTCASENAME_NOT_STRING', 5020);
define('TESTCASENAME_NOT_STRING_STR',
    lang_get('API_TESTCASENAME_NOT_STRING', null, 1));
define('NO_TESTCASE_BY_THIS_NAME', 5030);
define('NO_TESTCASE_BY_THIS_NAME_STR',
    lang_get('API_NO_TESTCASE_BY_THIS_NAME', null, 1));
define('INVALID_TESTCASE_EXTERNAL_ID', 5040);
define('INVALID_TESTCASE_EXTERNAL_ID_STR',
    lang_get('API_INVALID_TESTCASE_EXTERNAL_ID', null, 1));
define('INVALID_TESTCASE_VERSION_NUMBER', 5050);
define('INVALID_TESTCASE_VERSION_NUMBER_STR',
    lang_get('API_INVALID_TESTCASE_VERSION_NUMBER', null, 1));
define('TCASE_VERSION_NUMBER_KO', 5051);
define('TCASE_VERSION_NUMBER_KO_STR',
    lang_get('API_TCASE_VERSION_NUMBER_KO', null, 1));
...
define('ATTACH_TEMP_FILE_CREATION_ERROR_STR',
    lang_get('API_ATTACH_TEMP_FILE_CREATION_ERROR', null, 1));

define('ATTACH_DB_WRITE_ERROR', 6002);
define('ATTACH_DB_WRITE_ERROR_STR', lang_get('API_ATTACH_DB_WRITE_ERROR', null,
    1));

define('ATTACH_FEATURE_DISABLED', 6003);
define('ATTACH_FEATURE_DISABLED_STR',
    lang_get('API_ATTACH_FEATURE_DISABLED', null, 1));
...
define('ATTACH_INVALID_ATTACHMENT_STR',
    lang_get('API_ATTACH_INVALID_ATTACHMENT', null, 1));

/**
 * 7000 level - Test Project errors
 */
define('INVALID_TESTPROJECTID', 7000);
define('INVALID_TESTPROJECTID_STR', lang_get('API_INVALID_TESTPROJECTID', null,
    1));
...
define('TESTPROJECTNAME_DOESNOT_EXIST_STR',
    lang_get('API_TESTPROJECTNAME_DOESNOT_EXIST', null, 1));

define('TESTPROJECTCOPY_SOURCENAME_DOESNOT_EXIST', 7012);
define('TESTPROJECTCOPY_SOURCENAME_DOESNOT_EXIST_STR',
    lang_get('API_TESTPROJECTCOPY_SOURCENAME_DOESNOT_EXIST', null, 1));
...
define('TESTSUITENAME_NOT_STRING_STR',
    lang_get('API_TESTSUITENAME_NOT_STRING', null, 1));

define('INVALID_PARENT_TESTSUITEID', 8003);
define('INVALID_PARENT_TESTSUITEID_STR',
    lang_get('API_INVALID_PARENT_TESTSUITEID', null, 1));

/**
 * 9000 level - Custom Fields
 */
define('NO_CUSTOMFIELD_BY_THIS_NAME', 9000);
define('NO_CUSTOMFIELD_BY_THIS_NAME_STR',
    lang_get('API_NO_CUSTOMFIELD_BY_THIS_NAME', null, 1));

define('CUSTOMFIELD_NOT_APP_FOR_NODE_TYPE', 9001);
define('CUSTOMFIELD_NOT_APP_FOR_NODE_TYPE_STR',
    lang_get('API_CUSTOMFIELD_NOT_APP_FOR_NODE_TYPE', null, 1));

define('CUSTOMFIELD_HAS_NOT_DESIGN_SCOPE', 9002);
define('CUSTOMFIELD_HAS_NOT_DESIGN_SCOPE_STR',
    lang_get('API_CUSTOMFIELD_HAS_NOT_DESIGN_SCOPE', null, 1));

define('CUSTOMFIELD_NOT_ASSIGNED_TO_TESTPROJECT', 9003);
define('CUSTOMFIELD_NOT_ASSIGNED_TO_TESTPROJECT_STR',
    lang_get('API_CUSTOMFIELD_NOT_ASSIGNED_TO_TESTPROJECT', null, 1));

define('NO_CUSTOMFIELDS_DT_LINKED_TO_TESTCASES', 9004);
define('NO_CUSTOMFIELDS_DT_LINKED_TO_TESTCASES_STR',
    lang_get('API_NO_CUSTOMFIELDS_DT_LINKED_TO_TESTCASES', null, 1));

define('NO_CUSTOMFIELDS_DT_LINKED_TO_TESTSUITES', 9005);
define('NO_CUSTOMFIELDS_DT_LINKED_TO_TESTSUITES_STR',
    lang_get('API_NO_CUSTOMFIELDS_DT_LINKED_TO_TESTSUITES', null, 1));

define('NO_CUSTOMFIELDS_DT_LINKED_TO_BUILDS', 9006);
define('NO_CUSTOMFIELDS_DT_LINKED_TO_BUILDS_STR',
    lang_get('API_NO_CUSTOMFIELDS_DT_LINKED_TO_BUILDS', null, 1));

/**
 * 10000 level - User
 */
define('NO_USER_BY_THIS_LOGIN', 10000);
define('NO_USER_BY_THIS_LOGIN_STR', lang_get('API_NO_USER_BY_THIS_LOGIN', null,
    1));
...
define('NO_REQ_IN_THIS_PROJECT_STR',
    lang_get('API_NO_REQ_IN_THIS_PROJECT', null, 1));

/**
 * 12000 level - Platforms
 */
define('PLATFORMNAME_ALREADY_EXISTS', 12000);
define('PLATFORMNAME_ALREADY_EXISTS_STR',
    lang_get('API_PLATFORMNAME_ALREADY_EXISTS', null, 1));

define('PLATFORM_REMOVETC_NEEDED_BEFORE_UNLINK', 12001);
define('PLATFORM_REMOVETC_NEEDED_BEFORE_UNLINK_STR',
    lang_get('API_PLATFORM_REMOVETC_NEEDED_BEFORE_UNLINK', null, 1));
...
define('USER_LOGIN_DOESNOT_EXIST_STR',
    lang_get('API_USER_LOGIN_DOESNOT_EXIST', null, 1));
...
define('ROLE_NAME_DOESNOT_EXIST_STR',
    lang_get('API_ROLE_NAME_DOESNOT_EXIST', null, 1));
