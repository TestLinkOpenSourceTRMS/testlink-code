...
function runTest(&$client, $method, $args, $feedback_id = 1)
{
    ...
    $imgFO = dirname(__FILE__) . DIRECTORY_SEPARATOR . 'img' .
        DIRECTORY_SEPARATOR . 'icon-foldout.gif';
    $imgSRC = ' <img src="' . $imgFO . '"' . ' align="top" title="show/hide">';
    ...
    echo '<div class="detail-container" id="' . $html_id .
        '" style="display: none;">';
