...
$unitTestDescription = "Test - {$method} - ONLY BUILD ID Filter => " .
    $args["buildid"];
...
$args["buildname"] = '1';
$unitTestDescription = "Test - {$method} - ONLY BUILD NAME Filter => " .
    $args["buildname"];
...
$unitTestDescription = "Test - {$method} - ONLY PLATFORM NAME Filter => " .
    $args["platformname"];
