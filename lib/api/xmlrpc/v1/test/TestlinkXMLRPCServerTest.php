...
class TestlinkXMLRPCServerTest extends PHPUnit_Framework_TestCase
{
    ...
    private function setupTestMode()
    {
        ...
        if (! $this->client->query('tl.setTestMode', $data)) {
            echo "\n" . $this->getName() . " >> problem setting testMode - " .
    ...
    public static function suite()
    {
        ...
        $suite->addTest(
            new TestlinkXMLRPCServerTest('testReportTCResultWithInvalidDevKey'));
        $suite->addTest(
            new TestlinkXMLRPCServerTest('testReportTCResultWithoutDevKey'));
        $suite->addTest(
            new TestlinkXMLRPCServerTest('testReportTCResultWithEmptyDevKey'));
        $suite->addTest(
            new TestlinkXMLRPCServerTest('testReportTCResultWithoutTCID'));
        $suite->addTest(
            new TestlinkXMLRPCServerTest('testReportTCResultWithInvalidTCID'));
        $suite->addTest(
            new TestlinkXMLRPCServerTest('testReportTCResultWithoutNonIntTCID'));
        $suite->addTest(
            new TestlinkXMLRPCServerTest('testReportTCResultWithoutTPID'));
        $suite->addTest(
            new TestlinkXMLRPCServerTest(
        ...
        $suite->addTest(
            new TestlinkXMLRPCServerTest('testReportTCResultValidRequest'));
        $suite->addTest(
            new TestlinkXMLRPCServerTest('testReportTCResultWithNoParams'));

        $suite->addTest(
            new TestlinkXMLRPCServerTest(
                'testReportTCResultRequestWithValidBuildID'));
        $suite->addTest(
            new TestlinkXMLRPCServerTest('testReportTCResultNotGuessingBuildID'));

        $suite->addTest(
            new TestlinkXMLRPCServerTest('testReportTCResultWithNotes'));
        $suite->addTest(
            new TestlinkXMLRPCServerTest('testCreateBuildWithoutNotes'));
        $suite->addTest(
            new TestlinkXMLRPCServerTest('testCreateBuildWithNotes'));
        $suite->addTest(
            new TestlinkXMLRPCServerTest('testCreateBuildWithInvalidTPID'));
        ...
        $suite->addTest(
            new TestlinkXMLRPCServerTest('testGetTestCasesForTestSuite'));
        $suite->addTest(
            new TestlinkXMLRPCServerTest(
    ...
    private function testSayHello()
    {
        if (! $this->client->query('tl.sayHello')) {
            die(
                'big time problem ' . $this->client->getErrorCode() . ' : ' .
    ...
    private function testCreateBuildWithNotes()
    {
        ...
        $data["testplanid"] = TestlinkXMLRPCServerTestData::testTPID;
        $data["buildnotes"] = "Some notes from the build created at " .
            @strftime("%c");
    ...
    private function testRepeat()
    {
        ...
        $this->assertEquals("You said: " . $data["str"],
            $this->client->getResponse());
    }
