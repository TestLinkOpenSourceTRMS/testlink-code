...
abstract class codeTrackerInterface
{
    ...
    public function connect()
    {
        ...
        $result = $this->dbConnection->connect(false, $this->cfg->dbhost,
            $this->cfg->dbuser, $this->cfg->dbpassword, $this->cfg->dbname);
     ...
     *
     */
    public function buildViewCodeLink($project_key, $repository_name, $code_path,
        $opt = null)
    {
        $branch_name = null;
        $commit_id = null;
        ...
        $link = "<a href='" .
            $this->buildViewCodeURL($project_key, $repository_name, $code_path,
                $branch_name, $commit_id) . "' target='_blank'>";
     ...
     * @return string
     */
    public function buildViewCodeURL($project_key, $repository_name, $code_path,
        $branch_name = null, $commit_id = null)
    {
        $codeURL = $this->cfg->uriview . $project_key . '/repos/' .
            $repository_name . '/browse/' . $code_path;
    ...
    public static function getCfgTemplate()
    {
        throw new RuntimeException(
            "Unimplemented - YOU must implement it in YOUR interface Class");
    }
