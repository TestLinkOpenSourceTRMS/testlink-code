...
echo "<pre> testsuite - constructor - testsuite(&\$db)";
echo "</pre>";
...
echo "</pre>";
$linked_cfields_at_design = $tsuite_mgr->get_linked_cfields_at_design(
    $tsuite_id);
...
echo "</pre>";
$linked_cfields_at_execution = $tsuite_mgr->get_linked_cfields_at_execution(
    $tsuite_id);
...
echo "</pre>";
$table_of_custom_field_inputs = $tsuite_mgr->html_table_of_custom_field_inputs(
    $tsuite_id);
echo "<pre>";
...
echo "</pre>";
$table_of_custom_field_values = $tsuite_mgr->html_table_of_custom_field_values(
    $tsuite_id);
echo "<pre><xmp>";
