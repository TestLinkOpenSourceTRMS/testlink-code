 ...
 *                           to execute the page
 */
function testlinkInitPage(&$db,
  $userRightsCheckFunction = "checkRights",$opt = null)
{
  static $pageStatistics = null;

  $my['opt'] = array('rightsCheckFn' => 'checkRights',
                     'initProject' => FALSE,
 ...
 *
 */
function tlInitWithCSRF(&$db,$opt=null)
{
  $opt['csrfGuard'] = TRUE; 
  testlinkInitPage($db,$rightCheckFn,$opt);  
}

/**
 *
 */
function tlInitWithoutCSRF(&$db,$opt=null)
{
  $opt['csrfGuard'] = FALSE; 
  testlinkInitPage($db,$rightCheckFn,$opt);  
}
 ...
 *
 */
function tlInitForAjax(&$db)
{
  $opt['csrfGuard'] = FALSE;
  $opt['rightsCheckFn'] = null;
  testlinkInitPage($db,$opt);
}