...
/**
 * Gets a value from session by its key.
 ...
 *            unique form name
 * @param unknown_type $token_value
 ...
 *
 * @param unknown_type $form_data_html
 *            HTML content
...
/**
 * Applies CSRF filter on Smarty template content.
 * Can be
...
/**
 * Validates the CSRF tokens found in $_POST variable.
 * Raoses user
