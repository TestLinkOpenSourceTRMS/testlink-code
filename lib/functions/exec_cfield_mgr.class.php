...
class exec_cfield_mgr extends cfield_mgr
{
     ...
     *
     * @param integer $htmlInputSize
     *            (optional) size of input field [chars]
     * @return string HTML
     * @uses function string_custom_field_input() from the parent class.
     */
    public function html_table_of_custom_field_inputs($htmlInputSize = 0)
    {
        $cf_smarty = '';
     ...
     *
     */
    private function get_set_values()
    {
