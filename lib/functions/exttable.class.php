...
class tlExtTable extends tlTable
{
     ...
     *            tableID is used to create a store for
     ...
     *            the custom things to enable for this type
     */
    ...
    /**
     * Build a JS object to describe the columns needed be EXT-JS GridPanel.
     * This
     ...
     * localized strings.
     * This is done in JS because we need the short codes
    ...
    /**
     * Outputs all js that is needed to render the table.
     * This inlcludes
     ...
     * constructor.
     * Important: The string returned starts with a comma.
     *
