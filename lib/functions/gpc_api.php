<?php
/**
 * This script contains functions for GPC keys. It was adapted from the original 
 * script in Mantis project. Both scripts are licensed under the GPL license, and 
 * the copyrights of the original script were kept below. 
 * 
