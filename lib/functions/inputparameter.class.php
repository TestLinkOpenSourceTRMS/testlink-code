...
class tlInputParameter extends tlObject
{
     ...
     * constructor
     *
     * @param tlInputParameter $parameterInfo
     *            Infos about the parameter source
     * @param tl<TYPE>ValidationInfo $validationInfo
     *            Info about the validation of the parameter
     */
...
class tlStringValidationInfo
{
     ...
     *
     * @param string $value
     *            the string to strip the slashes of
...
class tlIntegerValidationInfo
{
     ...
     *            the value which should normalized
...
class tlArrayValidationInfo
{
     ...
     *            the array which should be normalized
     ...
     *
     * @param array $valueArray
     *            the array of values which should be validated
...
class tlCheckBoxValidationInfo
{
     ...
     *
     * @param string $value
     *            the value which should be normalized
