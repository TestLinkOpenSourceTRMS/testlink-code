 ...
 *            generic array about the parameter see examples below of usage
 * @param object $args
 *            an optional object to which each parameter is added as a property
 *
 ...
 *
 * @param string $source
 *            name of the source to fetch could be "POST", "GET", "REQUEST"
 * @param array $paramInfo
 *            generic array about the parameter see examples below of usage
 * @param object $args
 *            an optional object to which each parameter is added as a property
 ...
 *            the name of the source, "GET","POST","REQUEST"
 * @param string $name
 ...
 * @param string $regExp
 *            a regular Expression for preg_ functions used the validate
 * @param string $pfnValidation
 *            a callback function used to validate
 * @param string $pfnNormalization
 *            a callback function used to normalize
 *
