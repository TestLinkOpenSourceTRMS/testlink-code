 ...
 * 1.
 * The string in the current user's preferred language (if defined)
 * 2. The string in English
 *
 * @param mixed $p_string
 *            string or array of string with term keys
 *
 * @internal revisions
 */
 ...
 *            something to be inserted in the first string
 ...
 *            list of localization string keys
 ...
 *
 * @param array $params
 *            used only if you call this from an smarty template
 *            or a wrapper in an smarty function.
 * @param integer $smarty:
 *            when not used in an smarty template, pass NULL.
 * @param $what: give
 *            info about what kind of value is contained in value.
 *            possible values: timestamp_format || date_format
 * @param $value: must
 *            be a date or time stamp in ISO format
