 ...
 * @param $params params
 *            which should be inserted into the localized label
...
class tlMetaString extends tlObject
{
     ...
     *
     * @param $label string
     *            the label to localize, use {%1} to {%n} for parameters inserted into the localized string
     * @param $args array
     ...
     *
     * @param $locale string
     *            any valid locale (which is supported by TestLink)
