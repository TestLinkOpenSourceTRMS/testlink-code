...
abstract class tlObject implements iSerialization
{
     ...
     *            a localized message as user feedback
     */
     ...
     *            of tablenames, to get only some of the tables
...
abstract class tlObjectWithDB extends tlObject
{
     ...
     *
     * @param
     *            object [ref] $db the database connection
     */
...
abstract class tlObjectWithAttachments extends tlObjectWithDB
{
     ...
     * @param
     *            object [ref] $db the database connection
     * @param string $attachmentTableName
     *            the foreign key table name to store the attachments
     */
     ...
     *
     * @param integer $id
     *            this is the fkid of the attachments table
...
abstract class tlDBObject extends tlObject implements iDBSerialization
{
     ...
     *
     * @param integer $dbID
     *            (optional) the database identifier
     */
     ...
     *
     * @param $level integer
     *            any combination of TLOBJ_O_GET_DETAIL_? constancts
     */
     ...
     *            object [ref] $db the database connection
     * @param int $id
     *            the id of the object to be created (must exist in the database)
     * @param string $className
     *            the class name of the object
     * @param int $options
     *            some additional options for creating the options (these are class specific)
     ...
     *            object [ref] $db the database connection
     * @param string $query
     *            the ids of the objects to be created are obtained by this query
     * @param string $column
     *            the name of the column which delivers the ids
     * @param string $className
     *            the class name of the objects
     * @param boolean $returnAsMap
     *            if set to true, to objects are returned in a
     ...
     *            object [ref] $db the database connection
     * @param array $ids
     *            the ids of the objects to be created
     * @param string $className
     *            the class name of the objects
     * @param boolean $returnAsMap
     *            if set to true, to objects are returned in a
     ...
     *
     * @param
     *            object [rerf] $db the database connection
     * @param int $id
     *            the database-id of the object which should be deleted
     * @param string $className
     *            the class name of the object
     *
