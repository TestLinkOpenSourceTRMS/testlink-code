...
class tlPageStatistics extends tlObjectWithDB
{
     ...
     *
     * @param
     *            resource &$db reference to resource of the database connection
     */
     ...
     *
     * @param string $title
     *            the title of the performance counter
     * @param integer $type
     *            the type of the performance Counter, any combination of
