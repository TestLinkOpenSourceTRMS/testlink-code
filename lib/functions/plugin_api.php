 ...
 *            string Page name
 * @param
 *            string Plugin basename (defaults to current plugin)
 */
 ...
 *
 * @param
 *            array Array of configuration option name/value pairs.
 */
 ...
 *
 * @param
 *            array Array of event name/callback key/value pairs
 */
 ...
 *
 * @param
 *            string Plugin classname without 'Plugin' postfix
 */
function plugin_register($p_basename, $p_return = false)
{
    ...
    if (! isset($g_plugin_cache[$p_basename])) {
        ...
        if (! class_exists($t_classname) && ! plugin_include($p_basename)) {
            return null;
        }
