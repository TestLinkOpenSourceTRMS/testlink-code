...
print "function  <BR>";
print "function viewer_edit_new(\$amy_keys, \$oFCK, \$action, \$parent_id, \$id=null) <BR>";
print "function update(\$id, \$tcversion_id, \$name, \$summary, \$steps, \$expected_results, \$user_id, \$keywords_id='', \$tc_order=null) <BR>";
print "function check_link_and_exec_status(\$id) <BR>";

print "function delete(\$id, \$version_id=TC_ALL_VERSIONS) <BR>";
print "function get_linked_versions(\$id, \$status=ALL) <BR>";
print "function _blind_delete(\$id, \$version_id=TC_ALL_VERSIONS) <BR>";
print "function _execution_delete(\$id, \$version_id=TC_ALL_VERSIONS) <BR>";

print "function get_testproject(\$id) <BR>";
print "function copy_to(\$id, \$parent_id, \$user_id, \$copyKeywords = 0) <BR>";
