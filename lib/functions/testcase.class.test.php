...
print "<h3>/lib/functions/testcase.class.test.php</h3>";
print "author : Kevin Levy <BR>";
print "last updated 20060630 <BR>";
print "<BR>This page displays the functions in /lib/functions/testcase.class.php and examples of their usage.  This page will first call an initialization method, then the testplan class will be instantiated, then we will retrieve the current testplan and testproject ids.  Once this initial information has been gathered, each method of the testplan class will be used and we will inspect the results.<BR>";
