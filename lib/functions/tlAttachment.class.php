...
class tlAttachment extends tlDBObject
{
    ...
    public function getInfo()
    {
        return array(
            ...
            "inlineString" => $this->inlineString,
     ...
     * @param $id the
     *            database identifier of the attachment
     * @param $detailLevel the
     *            detailLevel
     ...
     *            and addtional where clause
     * @param $column string
     *            the name of column which holds the id
