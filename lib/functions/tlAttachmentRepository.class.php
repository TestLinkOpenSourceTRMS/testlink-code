...
class tlAttachmentRepository extends tlObjectWithDB
{
     ...
     *
     * @param int $fkid
     *            the foreign key id (attachments.fk_id)
     * @param string $fktableName
     *            the tablename to which the $id refers to (attachments.fk_table)
     * @param string $title
     *            the title used for the attachment
     * @param array $fInfo
     *            should be $_FILES in most cases
     *
     ...
     *
     * @param string $destFName
     *            the fileName
     * @param string $tableName
     *            the tablename to which $id referes to (attachments.fk_table)
     * @param int $id
     *            the foreign key id attachments.fk_id)
     *
     ...
     *
     * @param string $fTmpName
     *            the filename of the attachment
     * @param string $destFName
     *            a unique file name for temporary usage
     *
     ...
     * @param string $fTmpName
     *            the filename
     * @param string $destFPath
     *            [ref] the destination file name
     *
     ...
     *            the foreign key id attachments.fk_id)
     * @param bool $mkDir
     *            if true then the the directory will be created, else not
     *
     ...
     *
     * @param $dummy not
     *            used, only there to keep the interface equal to deleteAttachmentFromDB
     * @param $attachmentInfo array
     *            with information about the attachments
     ...
     *            the database identifier of the attachment
     * @param $attachmentInfo array,
     *            optional information about the attachment
     * @return integer returns tl::OK on success, tl::ERROR else
     */
     ...
     *
     * @param $base64encodedContent base64
     ...
     */
    public function copyAttachments($source_id, $target_id, $fkTableName)
    {
        $mapping = null;
        $f_parts = null;
        $destFPath = null;
