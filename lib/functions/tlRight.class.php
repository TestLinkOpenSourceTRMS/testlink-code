...
class tlRight extends tlDBObject implements iDBBulkReadSerialization
{
     ...
     *            any combination of TLOBJ_O_ Flags
     */
     ...
     *
     * @param integer $dbID
     *            the database id of the right
     * @param string $name
     *            the name of the right
     */
    private function initialize($dbID, $name)
    {
        $this->dbID = $dbID;
        $this->name = $name;
    }
     ...
     *            the detail level, any combination TLOBJ_O_GET_DETAIL_ flags
     *
