...
class TLSmarty extends Smarty
{
    ...
    public function __construct()
    {
        ...
        $this->assign('gsmarty_timestamp_format',
            $tlCfg->locales_timestamp_format[$my_locale]);
        ...
        $this->registerPlugin("function", "localize_date",
            "localize_date_smarty");
        $this->registerPlugin("function", "localize_timestamp",
            "localize_timestamp_smarty");
        $this->registerPlugin("function", "localize_tc_status",
        ...
        if ($tlCfg->csrf_filter_enabled && function_exists('smarty_csrf_filter')) {
    ...
    public static function getImageSet()
    {
        ...
        $dummy = array(
            ...
            'bug_link_tl_to_bts_disabled' => $imgLoc .
            'bug_link_disabled_famfamfam.png',
            'bug_create_into_bts_disabled' => $imgLoc .
            'bug_add_disabled_famfamfam.png',
            ...
            'cog' => $imgLoc . 'cog.png',
            'copyAttachments' => $imgLoc . 'folder_add.png',
