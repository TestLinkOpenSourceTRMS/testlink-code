...
*/
function dtree_renderExecTreeNodeOnOpen($node,$node_type,$tcase_node,
...
*/
function jtree_renderExecTreeNodeOnOpen($node,$node_type,$tc_action_enabled,$bForPrinting)
{
	$menustring = "['";
	$name = filterString($node['name']);
	$buildLinkTo = 1;
