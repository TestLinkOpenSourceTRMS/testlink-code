...
function initializeGui(&$db,&$args) {
  ...
  if ($args->tproject_id >0) {
    ...
    $kiki = 'testprojectID';
    $gui->tprojectID = intval(isset($_SESSION[$kiki]) ? $_SESSION[$kiki] : 0);
  }
  ...
  $gui->whoami = $args->user->getDisplayName() . ' ' . $guiCfg->role_separator_open . $testprojectRole . $guiCfg->role_separator_close;
