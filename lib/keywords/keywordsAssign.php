...
switch ($args->edit) {
    ...
    case 'testsuite':
        ...
        $gui->keyword_assignment_subtitle = lang_get('test_suite') . TITLE_SEP .
            $testsuite['name'];
    ...
    case 'testcase':
        ...
        if ($gui->canAddRemoveKWFromExecuted || ! $gui->hasBeenExecuted) {
            $kwQty = is_null($args->keywordArray) ? 0 : count($args->keywordArray);
...
function initArgs(&$opt_cfg)
{
    ...
    $args->tcaseSet = isset($_SESSION['edit_mode']) &&
        isset($_SESSION['edit_mode'][$args->form_token]['testcases_to_show']) ? $_SESSION['edit_mode'][$args->form_token]['testcases_to_show'] : null;
