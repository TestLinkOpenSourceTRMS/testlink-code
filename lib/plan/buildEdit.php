 ...
 * @modified $Date: 2009/05/08 06:44:56 $ $Author: franciscom $
 *
 * rev :
 *      20080827 - franciscom - BUGID
...
function init_args($request_hash, $session_hash)
{
    ...
    // 20090507 - franciscom
    // Set to today + 45 days
    $defaultReleaseDate = mktime(0, 0, 0, date("m")  , date("d")+45, date("Y"));
    $args->release_date = date("Y-m-d", $defaultReleaseDate);
