...
$args = initArgs($db, $date_format_cfg);
 ...
 *
 */
function initArgs(&$dbHandler, $dateFormat)
{
    ...
    if (isset($_REQUEST['target_date']) && $_REQUEST['target_date'] != '') {
        ...
        if ($date_array != null) {
            ...
            $args->target_date = $date_array['year'] . "-" . $date_array['month'] .
                "-" . $date_array['day'];
        }
    }
    ...
    if (isset($_REQUEST['start_date']) && $_REQUEST['start_date'] != '') {
        ...
        if ($date_array != null) {
            // set date in iso format
            $args->start_date = $date_array['year'] . "-" . $date_array['month'] .
                "-" . $date_array['day'];
        }
    }
