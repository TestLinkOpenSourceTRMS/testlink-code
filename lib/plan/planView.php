...
if ($args->tproject_id && checkRights($db, $args->user, $args->tproject_id)) {
    ...
    $gui->tplans = $args->user->getAccessibleTestPlans($db, $args->tproject_id,
        null, array(
            'output' => 'mapfull',
            'active' => null
        ));
...
function initArgs()
{
    ...
    $args->tproject_name = isset($_SESSION['testprojectName']) ? trim(
...
function initializeGui(&$dbHandler, $argsObj)
{
    ...
    $gui->grants->testplan_create = $argsObj->user->hasRight($dbHandler,
