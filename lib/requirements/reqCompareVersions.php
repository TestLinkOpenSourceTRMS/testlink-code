 ...
 * @version    	CVS: $Id: reqCompareVersions.php,v 1.5.2.1 2010/11/28 10:52:39 franciscom Exp $
 * @link 		http://www.teamst.org/index.php
 *
 * Compares selected requirements versions with each other.
 *
 * @internal Revisions:
 * 20101128 - franciscom - init_args() adding code to remove event viewer warnings
