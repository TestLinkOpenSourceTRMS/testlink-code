...
function initArgs()
{
    ...
    $args->req_version_id = isset($_REQUEST['req_version_id']) ? intval(
        $_REQUEST['req_version_id']) : 0;
    $args->req_revision = isset($_REQUEST['req_revision']) ? intval(
        $_REQUEST['req_revision']) : 0;
