...
if ($args->doCompare) {
    ...
    $sbs = getItemsToCompare($args->left_item_id, $args->right_item_id,
        $gui->items);
    prepareUserFeedback($db, $gui, $labels, $sbs);
...
function initArgs()
{
    ...
    $args->useDaisyDiff = (isset($_REQUEST['diff_method']) &&
        ($_REQUEST['diff_method'] == 'htmlCompare')) ? 1 : 0;
...
/**
 */
function prepareUserFeedback(&$dbHandler, &$guiObj, $labels, $sbs)
{
