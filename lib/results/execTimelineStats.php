...
function initializeGui(&$dbHandler, $argsObj, &$tplanMgr)
{
    ...
    $gui->actionSendMail = $gui->basehref .
        "lib/results/execTimelineStats.php?format=" . FORMAT_MAIL_HTML .
        "&tplan_id={$gui->tplan_id}" . "&tproject_id={$gui->tproject_id}";

    $gui->actionSpreadsheet = $gui->basehref .
        "lib/results/execTimelineStats.php?format=" . FORMAT_XLS .
