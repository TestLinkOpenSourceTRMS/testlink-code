 ...
 * @param database $db
 * @param stdClass $args
 *            object containing User Input and some session values
 *            TBD structure
 *
...
function initializeGui(&$db, $args)
{
    ...
    switch ($args->doc_type) {
        case DOC_REQ_SPEC:
            ...
            $gui->ajaxTree->loader = $args->basehref .
        ...
        case DOC_TEST_SPEC:
            ...
            $gui->ajaxTree->loader = $args->basehref .
                ...
                "show_tcases=0&operation=print&" . "tcprefix=" .
                urlencode($tcasePrefix . $tcaseCfg->glue_character) . "}";
 ...
 * @param stdClass $args
 *            reference to user input parameters
 * @return array $cbSet
 */
