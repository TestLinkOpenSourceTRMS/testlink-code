...
{
    $args = new stdClass();
    $args->tprojectID = isset($_SESSION['testprojectID']) ? intval(
...
function initializeGui(&$dbHandler, &$argsObj)
{
    ...
    $gui = new stdClass();
    $gui->tcasePrefix = $tproject_mgr->getTestCasePrefix($argsObj->tprojectID) .
    ...
    $gui->design_cf = $tproject_mgr->cfield_mgr->get_linked_cfields_at_design(
