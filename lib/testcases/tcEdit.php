...
if($args->delete_tc_version) {
    ...
    $msg = '';
    $sq = null;
    if(!is_null($exec_status_quo) && isset($exec_status_quo[$args->tcversion_id])) {
...
function initializeGui(&$dbHandler,&$argsObj,$cfgObj,&$tcaseMgr,&$tprojMgr) {
    ...
    $guiObj->loadOnCancelURL = $_SESSION['basehref'] . "/lib/testcases/archiveData.php?edit=testcase&id=" . $argsObj->tcase_id .
