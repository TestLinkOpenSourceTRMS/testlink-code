 ...
 *
 * @param database $db reference to db object
 * @return array
 */
...
function buildMatrix(&$guiObj,&$argsObj)
{
    ...
    init_labels(array('th_login' => null,'th_first_name' => null,
...
function getAllUsersForGrid(&$dbHandler)
{
    ...
    for($idx=0; $idx < $loop2do; $idx++)
    {
        ...
        if($ed != '')
        {
            $users[$idx]['expiration_date'] = localize_dateOrTimeStamp(null,$dummy,'date_format',$ed);
        }
    }
