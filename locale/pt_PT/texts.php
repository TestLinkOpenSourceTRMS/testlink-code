...
$TLS_htmltext['error'] 		= "<p>Um erro inesperado ocorreu. Por favor, verifique o <i>event viewer</i> ou " .
...
<h2>Iniciar:</h2>
<ol>
	<li>Selecione seu Projecto de Teste na árvore de navegação (o nó principal). <i>Observe: " .
	...
	"Suíte de Teste poderia conter o âmbito dos Casos de Teste incluídos, configuração padrão, " .
	...
	"a metáfora do &quot;diretório&quot;, assim os utilizadores podem mover e copiar Suítes de Teste dentro " .
	"do Projecto de Teste. Além disso, eles podem ser importados ou exportados (incluindo os Casos de Teste nele contidos).</li>
	<li>Suítes de Teste são pastas escaláveis. Os utilizadores podem mover ou copiar Suítes de Teste dentro " .
	"do Projecto de Teste. Suítes de Teste podem ser importadas ou exportadas (incluindo os Casos de Teste).
...
<p>Navegue de acordo com palavras-chave e/ou strings procuradas. A busca não é sensível a maiúsculas. Os resultados incluem apenas Casos de Teste do Projecto de Teste atual.</p>
...
Suíte de Teste, ou Projecto de Teste. Uma página pronta para impressão será exibida.</p>
</li>
...
ou importar requisitos para o documento. Cada requisito tem um título, âmbito e status.
...
requisitos activos na tela de especificação de requisitos. Estes Casos de Teste são criados dentro da Suíte de Teste 
...
<p>Atribuir Palavras-chave à Suíte de Teste afetará Casos de Teste 
...
utilizando a funcionalidade 'Actualizar Versão dos Casos de Teste' antes de fazer a atribuição das Palavras-chave.</p>";
...
<ol>
	...
	<li>Preencha o resultado do Caso de Teste, suas respectivas notas e/ou Ocorrências.</li>
	<li>Salve os resultados.</li>
</ol>
<p><i>Nota: O TestLink deve ser configurado para colaborar com seu Gestor de Falhas  
...
<p>O botão imprimir activa a impressão para um único relatório (sem navegação).</p>
...
<p>Esta página apenas exibe o último status de um Plano de Teste por Suíte de Teste, Testador e palavras-chave.
...
permite aos utilizadores filtrar os resultados e gerar relatório específicos para Testadores em específico, palavras-chave, Suítes de Teste 
...
então todos os Casos de Teste serão considerados indiferentes de Testador atribuído. Actualmente não há funcionalidade 
...
Apenas as Suítes de Teste que são selecioadas serão consultadas para as métricas do resultado. Se você está apenas interessado em resultados 
...
'Prioridade 1', e todas as Suítes de Teste disponíveis, apenas Casos de Teste com Prioridade 1 atribuídos para José serão considerados. 
...
exibidas nos Ciclos de Teste selecionados. No entanto, o resumo para esta Suíte de Teste apenas incluirá o último resultado para 
...
<p>As seções e barras dos gráficos são coloridos de modo que o utilizador possa identificar o número aproximado de Casos de Teste com status 
Passou, Falhou, Bloqueado e Não Executado.</p>

<h3>Ocorrências por Casos de Teste</h3>
<p>Este relatório exibe cada Caso de Teste com todos as Ocorrências abertas para ele em todo o projecto. 
Este relatório apenas está disponível se estiver conectado um Gestor de Falhas.</p>";
...
<p>Permite aos utilizadores (com perfil de Líder de Testes) a adicionar ou remover Casos de Teste do Plano de Teste.</p>
