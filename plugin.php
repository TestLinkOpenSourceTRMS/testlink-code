...
$plugin_page_qualified = TL_PLUGIN_PATH . $plugin_name . DIRECTORY_SEPARATOR .
    'pages' . DIRECTORY_SEPARATOR . $plugin_page . '.php';

if (! is_file($plugin_page_qualified)) {
    trigger_error('Cannot find plugin page: ' . $plugin_page_qualified,
        E_USER_NOTICE);
}
