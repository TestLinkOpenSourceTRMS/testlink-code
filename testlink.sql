...
-- 
-- Host: localhost
-- Generation Time: Nov 30, 2004 at 03:49 PM
...
CREATE TABLE `category` (
  ...
  KEY `id` (`id`),
  KEY `compid` (`compid`)
) TYPE=MyISAM COMMENT='This table holds all of the category information' AUTO_INCREMENT=124 ;
...
CREATE TABLE `keywords` (
  ...
  `notes` text,
  PRIMARY KEY  (`id`)
) TYPE=MyISAM COMMENT='this table holds all of the keywords for each product' AUTO_INCREMENT=5 ;
...
CREATE TABLE `mgtcategory` (
  ...
  PRIMARY KEY  (`id`),
  KEY `compid` (`compid`)
) TYPE=MyISAM COMMENT='The different categories of the TC management DB' AUTO_INCREMENT=80 ;
...
CREATE TABLE `mgtcomponent` (
  ...
  PRIMARY KEY  (`id`),
  KEY `prodid` (`prodid`)
) TYPE=MyISAM COMMENT='The different components of the TC management DB' AUTO_INCREMENT=8 ;
...
CREATE TABLE `mgtproduct` (
  ...
  PRIMARY KEY  (`id`)
) TYPE=MyISAM COMMENT='The different products of the TC management DB' AUTO_INCREMENT=6 ;
...
CREATE TABLE `mgttestcase` (
  ...
  PRIMARY KEY  (`id`),
  KEY `catid` (`catid`)
) TYPE=MyISAM COMMENT='The different test cases of the TC management DB' AUTO_INCREMENT=186 ;
...
CREATE TABLE `project` (
  ...
  PRIMARY KEY  (`id`),
  KEY `id` (`id`)
) TYPE=MyISAM COMMENT='This table holds all of the project information' AUTO_INCREMENT=115 ;
...
CREATE TABLE `testcase` (
  ...
  KEY `mgttcid` (`mgttcid`),
  KEY `catid` (`catid`)
) TYPE=MyISAM COMMENT='This table holds all of the test case information' AUTO_INCREMENT=20 ;
