...
FCKConfig.ToolbarSets["Pamgate_titolo"] = [
	['Bold','Italic','Underline','TextColor','BGColor']
] ;

FCKConfig.ToolbarSets["Pamgate_testo"] = [
	['Source','Preview','Templates','Cut','Copy','Paste','Undo','Redo','Find','Replace','SelectAll','Link','Unlink','Anchor'],
	'/',	
